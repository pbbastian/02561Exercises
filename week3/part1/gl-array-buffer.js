...
GLArrayBuffer.prototype.buffer = function(index, count, f) {
  if (!this._activated) return this.activate(this.buffer.bind(this, index, count, f))
  var gl = this._gl
  ...
  gl.bufferSubData(gl.ARRAY_BUFFER, index*this._byteLength, dataView)
}

// GLArrayBuffer.prototype.bufferArrays = function (index, )

GLArrayBuffer.prototype.clear = function() {
  if (!this._activated) return this.activate(this.clear);
