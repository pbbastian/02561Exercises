...
function init() {
    ...
    var positions = [].concat(backgroundQuad, tetrahedron);
    ...
    var program = initShaders(gl, '/week10/part4.vert', '/week10/part4.frag');
    ...
    var cubeTexture = createCubeTexture(gl, cubemapImages);
    
    gl.activeTexture(gl.TEXTURE1);
    var normalTexture = createNormalTexture(gl, normalImage);
    
    gl.uniform1i(programInfo.u_texture, 0);
    gl.uniform1i(programInfo.u_normal, 1);
...
function createNormalTexture(gl, image) {
